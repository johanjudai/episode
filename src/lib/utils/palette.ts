 ...
 * default palette.
 */
export type PaletteChoice = 'bauhaus' | 'ecobrutalism';

export const PALETTES: readonly PaletteChoice[] = ['bauhaus', 'ecobrutalism'] as const;
export const DEFAULT_PALETTE: PaletteChoice = 'bauhaus';

export function isPalette(value: unknown): value is PaletteChoice {
  return value === 'bauhaus' || value === 'ecobrutalism';
}
