...
<main class="app">
  <form class="onboarding" method="POST" action="?/complete">
    <Mark />
    ...
    <div>
      ...
      <p class="onboarding__lead">
        Sans pub, sans tracking. Vos données restent chez vous.
      </p>
    </div>
    ...
    <button type="submit" class="btn btn--accent btn--block btn--lg">Commencer →</button>
